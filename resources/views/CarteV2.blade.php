...
<body class="map" onload="playMusicBackground('musiques/musique-Carte')" >
	<div id='map'>
	    ...
	    <!-- Panneau -->
	        ...
	        <a href="/Cartev2-{!! $avatar !!}/Festayre-0" style="text-decoration:none">{!! Html::Image('/images/Panneau-1.png', "Panneau", ['id=Panneau-festayre class=panneau '], true) !!}</a>
	        <a href="/Cartev2-{!! $avatar !!}/Famille-0" style="text-decoration:none">{!! Html::Image('/images/Panneau-2.png', "Panneau", ['id=Panneau-famille class=panneau'], true) !!}</a>
	        <a href="/Cartev2-{!! $avatar !!}/Enfant-0" style="text-decoration:none">{!! Html::Image('/images/Panneau-3.png', "Panneau", ['id=Panneau-enfant class=panneau'], true) !!}</a>
	        <a href="/Cartev2-{!! $avatar !!}" style="text-decoration:none">{!! Html::Image('/images/Panneau-5.png', "Panneau", ['id=Panneau-carte class=panneau'], true) !!}</a>
	</div>
	...
	@foreach($data as $d)
		<script>
			...
			var lienPicto = "{{ URL::asset('images/', true) }}"+"/"+picto
			var idPicto = "{{ $d->id }}";
			var imgSurvol = "{{ $d->imgSurvol }}";
			var lienSurvol = "{{ URL::asset('images/Parcours', true) }}"+"/"+imgSurvol
	...
	<script type="text/javascript">
			...
			/* global TimelineLite */
				...
				var li = "{{$m->longitude}}";
				var picto = "{{ $m->image }}";
				var lienPicto = "{{ URL::asset('images/Monuments', true) }}"+"/"+picto
				var idPicto = "{{ $m->id }}";
