...
<html>
    ...
    <body class="parcoursChoisi" onload="playMusicBackground('musiques/musique-{{ $parcours }}')">
        <div class="headerParc">
            ...
            <!-- Avatar -->
            {!! Html::Image('/images/'.$avatar.'-bandeau.png', "MonAvatar", ['id=MonAvatar class="img-rounded"']) !!}
            <!-- Panneau -->
            {!! Html::Image('/images/panneau-baton.png', "BatonPann", ['id=BatonPann']) !!}
            <a href="/parcours-{!! $avatar !!}/Festayre" style="text-decoration:none">{!! Html::Image('/images/Panneau-1.png', "Panneau", ['id=Panneau-festayre class=panneau ']) !!}</a>
            <a href="/parcours-{!! $avatar !!}/Famille" style="text-decoration:none">{!! Html::Image('/images/Panneau-2.png', "Panneau", ['id=Panneau-famille class=panneau']) !!}</a>
            <a href="/parcours-{!! $avatar !!}/Enfant" style="text-decoration:none">{!! Html::Image('/images/Panneau-3.png', "Panneau", ['id=Panneau-enfant class=panneau']) !!}</a>
            <a href="/Cartev2-{!! $avatar !!}" style="text-decoration:none">{!! Html::Image('/images/Panneau-4.png', "Panneau", ['id=Panneau-carte class=panneau']) !!}</a>
        </div>
        <div class="container">
