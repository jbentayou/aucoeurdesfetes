...
<html>
    ...
    <body class="presentation" onload="playMusicBackground('musiques/27 course de vache 1')">
        <div class="text-center">
            <a href="/">{!! Html::Image('/images/logo ACDFB.png', "logo", ['id=logo class="img-rounded animated zoomIn"']) !!}</a>
            <div id="p1" class="container">
                ...
                {!! Html::Image('/images/aadp.jpg', "aadp", ['id=aadp width=19% class=partenaire']) !!}<br/>
                ...
                <section id="photoAvtr" class="row">
                    <div class="avatars col-md-12 col-xs-12">
                        {!! Html::Image('/images/homme-300.png', "homme", ['id=avatar1 onclick=selection(1,"homme") onmouseover=sonRire("homme") class="homme select"']) !!}
                        {!! Html::Image('/images/femme-300.png', "femme", ['id=avatar2 onclick=selection(2,"femme") onmouseover=sonRire("femme") class="femme select"']) !!}
                        {!! Html::Image('/images/garcon-300.png', "garcon", ['id=avatar3 onclick=selection(3,"garcon") onmouseover=sonRire("garcon") class="fils select"']) !!}
                        {!! Html::Image('/images/fille-300.png', "fille", ['id=avatar4 onclick=selection(4,"fille") onmouseover=sonRire("fille") class="fille select"']) !!}
                        ...
                        <!--<div id='bullePres3'>
                            {!! Html::Image('/images/bulle2.png', "bullePres5", ['id=bullePres5']) !!}
